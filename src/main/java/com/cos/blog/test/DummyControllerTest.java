...
public class DummyControllerTest {
	...
	public User detail(@PathVariable int id) {
		//user/4 을 찾으면 내가 데이터베이스에서 못찾아오게 되면 user가 null이 될것이다.
		//그럼 return null 이 리턴이 된다. 그럼 프로그램에 문제가 있다.
		//Option로 너의 User객체를 감싸서 가져올테니 null인지 아닌지 판단해해서 return
...
//		});
		...
		//만약에 자바 오브젝트를 리턴하게 되면 MessageConberter가 Jackson 라이브러리를 호출해서
